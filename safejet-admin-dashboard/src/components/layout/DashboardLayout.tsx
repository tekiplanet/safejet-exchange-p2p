...
import { 
    ...
    People as UserIcon,
    SwapHoriz as P2PIcon,
    AccountBalance as DepositIcon,
    ReceiptLong as DepositManageIcon,
...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 6h-4V4c0-1.1-.9-2-2-2h-4c-1.1 0-2 .9-2 2v2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zM10 4h4v2h-4V4z" />
        </svg>
      ),
    },
    {
    ...
    },
    {
      ...
      href: '/dashboard/sweep-transactions',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
